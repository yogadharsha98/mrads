...
const PostAdSell = () => {
  ...
  const { categoryFields, loading: fieldsLoading, error: fieldsError } = useSelector((state) => state.categoryFields);
        ...
        <div className="postad-form">
          ...
          <div className="form-field">
            ...
            >
              ...
              {error && <MenuItem disabled>Error loading categories: {error.message}</MenuItem>}
              {categories.length > 0 &&
